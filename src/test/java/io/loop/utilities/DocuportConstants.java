...
public class DocuportConstants {
    ...
    public static final String CLIENT_PASSWORD = "Group1";
    public static final String ADVISOR_PASSWORD = "Group1";
    public static final String SUPERVISOR_PASSWORD = "Group1";
    public static final String EMPLOYEE_PASSWORD = "Group1";
